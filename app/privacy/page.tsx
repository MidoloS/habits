const Privacy = () => {
  return (
    <main className="flex flex-col gap-8 p-7 container mx-auto text-zinc-50">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to HabitAI, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to HabitAI.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to HabitAI, accessible from{" "}
            <a
              href="https://www.habitai.io"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.habitai.io
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          Pictures and other information from your Devices camera and photo
          library
        </li>
      </ul>
      <p>
