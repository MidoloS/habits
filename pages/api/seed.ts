...
export default async function handler(
  ...
  const DATA = [
    ...
    },
    {
      ...
      points: 10,
      wideImg:
        "https://mabfjyjbggqdwqtjdwip.supabase.co/storage/v1/object/sign/images/walk_wide?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJpbWFnZXMvd2Fsa193aWRlIiwiaWF0IjoxNjkwNzY2MDIxLCJleHAiOjE3MjIzMDIwMjF9.3XZctpKN5S9xOy48K-B5Mg2hHM_2Ktw_G-IJpGsV1eo&t=2023-07-31T01%3A13%3A41.500Z",
      tallImage:
